...
class ActiviteController extends AbstractController
{
    ...
    #[Route('activity_drag_and_drop', name: 'activity_drag_and_drop')]
    public function dragAndDrop(Request $request, EntityManagerInterface $em)
    {
        $templates = 'dragAndDrop.html.twig'; //Template
